...
Elm.Chapter = Elm.Chapter || {};
Elm.Chapter.CoursePolicies = Elm.Chapter.CoursePolicies || {};
Elm.Chapter.CoursePolicies.make = function (_elm) {
   "use strict";
   _elm.Chapter = _elm.Chapter || {};
   _elm.Chapter.CoursePolicies = _elm.Chapter.CoursePolicies || {};
   if (_elm.Chapter.CoursePolicies.values)
   return _elm.Chapter.CoursePolicies.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   _P = _N.Ports.make(_elm),
   $moduleName = "Chapter.CoursePolicies";
   var data = {_: {}
   ...
   _elm.Chapter.CoursePolicies.values = {_op: _op
                                        ,data: data};
   return _elm.Chapter.CoursePolicies.values;
};
Elm.Chapter = Elm.Chapter || {};
Elm.Chapter.Schedule = Elm.Chapter.Schedule || {};
Elm.Chapter.Schedule.make = function (_elm) {
   "use strict";
   _elm.Chapter = _elm.Chapter || {};
   _elm.Chapter.Schedule = _elm.Chapter.Schedule || {};
   if (_elm.Chapter.Schedule.values)
   return _elm.Chapter.Schedule.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   _P = _N.Ports.make(_elm),
   $moduleName = "Chapter.Schedule";
   var data = {_: {}
              ...
              ,title: "Schedule"};
   _elm.Chapter.Schedule.values = {_op: _op
                                  ,data: data};
   return _elm.Chapter.Schedule.values;
};
Elm.Chapter = Elm.Chapter || {};
Elm.Chapter.Solutions = Elm.Chapter.Solutions || {};
Elm.Chapter.Solutions.make = function (_elm) {
   "use strict";
   _elm.Chapter = _elm.Chapter || {};
   _elm.Chapter.Solutions = _elm.Chapter.Solutions || {};
   if (_elm.Chapter.Solutions.values)
   return _elm.Chapter.Solutions.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   _P = _N.Ports.make(_elm),
   $moduleName = "Chapter.Solutions";
   var data = {_: {}
              ...
              ,title: "Solutions"};
   _elm.Chapter.Solutions.values = {_op: _op
                                   ,data: data};
   return _elm.Chapter.Solutions.values;
};
Elm.Char = Elm.Char || {};
...
Elm.Contents.make = function (_elm) {
   ...
   $moduleName = "Contents",
   $Chapter = Elm.Chapter.make(_elm),
   $Chapter$CoursePolicies = Elm.Chapter.CoursePolicies.make(_elm),
   $Chapter$Schedule = Elm.Chapter.Schedule.make(_elm),
   $Chapter$Solutions = Elm.Chapter.Solutions.make(_elm);
   var chapters = $Chapter.makeChapters(_L.fromArray([$Chapter$CoursePolicies.data
